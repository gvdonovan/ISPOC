    ...
    public static class MyApiResourceProvider
    {
        ...
        public static IEnumerable<ApiResource> GetAllResources()
        {
            return new[]
            {
                ...
                new ApiResource(
                    ...
                    new[] { JwtClaimTypes.Name, JwtClaimTypes.Role, "module" }) // Claims to be included in access token
                //    ,
                //new ApiResource
                //{
                //    Name = "myAPIs",
                //    UserClaims = new[] { JwtClaimTypes.Name, JwtClaimTypes.Role, "office", "module" }
                //}                    
            };
        }
        ...
        public static IEnumerable<IdentityResource> GetIdentityResources()
        {
            return new List<IdentityResource>
            {
                ...
                {
                    Name = "biff"     ,
                    UserClaims = new[] { JwtClaimTypes.Name, JwtClaimTypes.Role, "office", "module", "module.permissions" }
                }
